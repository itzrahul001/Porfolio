  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      ...
      <div className="dark:bg-dark-card p-4">
        ...
        <div
          className={`text-content font-light pt-4 transition-all duration-300 ${
        ...
        <button
          ...
          className="mt-2 text-blue-500 dark:text-blue-400 underline hover:text-blue-700 dark:hover:text-blue-300"
        >
