...
function Work({ position, company, location, type, duration, cgpa }) {
  return (
  ...
  <circle cx="3" cy="6" r="2" fill="#e2e2e2"/>
  <circle cx="8" cy="6" r="2" fill="black"/>
  <circle cx="13" cy="6" r="2" fill="#e2e2e2"/>
</svg>


            <p className="text-content text-xs md:text-sm font-light pl-1">CGPA :</p> <span className="text-content text-xs md:text-sm font-light pl-1 min-w-fit">{cgpa}</span>
          </div>
